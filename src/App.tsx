                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`text-xs font-black p-2 rounded-xl border-2 border-[#2D3047] transition-all cursor-pointer text-center flex flex-col justify-center items-center gap-1 ${isSelected
              ...
              <div className="bg-white border-4 border-[#2D3047] rounded-3xl p-5 shadow-[6px_6px_0px_#2D3047]">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <button
                    ...
                    className={`p-2.5 rounded-xl font-bold text-xs uppercase shadow-[3px_3px_0px_#2D3047] border-2 border-[#2D3047] transition-all cursor-pointer ${selectedCategory === 'all'
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-xl font-bold text-xs uppercase shadow-[3px_3px_0px_#2D3047] border-2 border-[#2D3047] transition-all cursor-pointer ${selectedCategory === 'food'
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-xl font-bold text-xs uppercase shadow-[3px_3px_0px_#2D3047] border-2 border-[#2D3047] transition-all cursor-pointer ${selectedCategory === 'drink'
                  ...
                  <div className="mt-4 pt-3 border-t-2 border-stone-100">
                    ...
                    <div className="flex flex-wrap gap-1.5 max-h-[140px] overflow-y-auto pr-1">
                      <button
                        ...
                        className={`text-[10px] font-bold px-2.5 py-1.5 rounded-full border transition-all cursor-pointer ${selectedSubCategory === 'all'
                            ? 'bg-[#2D3047] text-white border-[#2D3047] shadow-[1px_1px_0px_#2D3047]'
                      ...
                      {availableSubCategories.map(cat => (
                        <button
                          ...
                          className={`text-[10px] font-bold px-2.5 py-1.5 rounded-full border transition-all cursor-pointer ${selectedSubCategory === cat
                              ? 'bg-[#FF6B35] text-white border-[#FF6B35] shadow-[1px_1px_0px_#2D3047]'
                              : 'bg-stone-50 text-stone-600 border-stone-200 hover:bg-stone-100'
                            }`}
                        >
                      ...
                      {[
                        ...
                        return (
                          <button
                            ...
                            className={`text-[10px] font-bold px-2.5 py-1 rounded-full border transition-all cursor-pointer ${isSelected
                    ...
                    {HANOI_MERGED_WARDS.map(ward => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center gap-1.5 p-1.5 rounded-xl border text-left transition-all text-[10px] font-extrabold cursor-pointer truncate ${isChecked
                ...
                >
                  {chatMessages.map((msg) => (
                    ...
                    >
                      ...
                      <div
                        className={`px-3 py-2 rounded-2xl text-[11px] leading-relaxed break-words font-medium select-text ${msg.sender === 'user'
                ...
                {aiResult && aiResult.suggestedItems && aiResult.suggestedItems.length > 0 && (
                  <div className="mt-2.5 bg-[#06D6A0]/10 border border-[#06D6A0]/20 p-2 rounded-xl flex items-center justify-between text-[10px]">
                    ...
                    <button
                      ...
                      className={`px-2 py-0.5 rounded text-[9px] font-black uppercase transition-all border-2 border-[#2D3047] shadow-[1px_1px_0px_#2D3047] active:translate-y-0.5 cursor-pointer ${onlyShowAIRecommended
